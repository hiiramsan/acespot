  ...
  return (
    <header className="sticky top-3 z-50 w-full">
      ...
      <div className="flex justify-center px-4">
        {/* Desktop Navbar */}
        <div className="hidden md:flex items-center h-14 bg-black rounded-full shadow-[0_4px_12px_rgba(0,0,0,0.25)] px-4 gap-4">
            ...
            {navLinks.map(({ href, label }) => {
              ...
              return (
                <Link
                  ...
                  className={`px-4 py-3 rounded-lg text-xs font-semibold tracking-widest transition-all ${
                    active
